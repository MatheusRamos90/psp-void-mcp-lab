...
/**
 * Propagates HTTP errors received from downstream services (psp-void-postgres-db,
 * psp-void-elasticsearch-db) back to the caller with the original status code and body.
 *
